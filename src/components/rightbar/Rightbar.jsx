      ...
      <>
       <div className="birthdayContainer">
            ...
            <span className="birthdayText">
              {" "}
              <b>Nicolas</b> cage and <b>4 other friends</b> have a birthday today.
            </span>
          </div>
    ...
    return(
      ...
      <div className="rightbarInfo">
        <div className="rightbarInfoItem">
          ...
          <span className="rightbarInfoValue">Alexandria</span>
        </div>
        <div className="rightbarInfoItem">
          <span className="rightbarInfoKey">From:</span>
          <span className="rightbarInfoValue">Eyad</span>
        </div>
        <div className="rightbarInfoItem">
